...
.qwee:hover{
    ...
    <body>
        ...
        <div class="s">
            ...
            <a href="logina.html" class="qwee" >	<font class="bb">EDIT-TABLE</font></a>&nbsp; &nbsp;
    ...
    <center>
        <table>
            ...
            <tr>
                ...
                <th>Time</th>
                    ...
                    <%
                        String frr = (String)request.getAttribute("frr");
                        String ttoo = (String)request.getAttribute("ttoo");
        ...
        String pass="kunal123@";
            ...
            String qry=("select * from Tm where rom='"+frr+"' and too='"+ttoo+"'");
