...
.qwee:hover{
    ...
    <body>
        <a href="loginf.html" class="qwee" >   <div class="logo">You Bus</div></a>
        <div class="s">
            <font class="bb"><a href="loginf.html" class="qwee" >HOME</a></font>&nbsp; &nbsp;
            <a href="loginf.html" class="qwee" >	<font class="bb">EDIT-TABLE</font></a>&nbsp; &nbsp;
    ...
    <center>
        <table>
            ...
            <tr>
                ...
                <th>Time</th>
                    ...
                    <%
                        String te = (String)request.getAttribute("te");
                        String tex = (String)request.getAttribute("tex");
        ...
        String pass="kunal123@";
            ...
            String qry=("select * from Tm where rom='"+te+"' and too='"+tex+"'");
